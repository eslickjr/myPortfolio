...
const Timeline = () => {
    ...
    return (
        <div id="timelinePage">
            <h1 id="timelineTitle">
                <img src={time} alt="Time" className="timeIcon icons"/>
                Timeline
                <img src={time} alt="Time" className="timeIcon icons"/>
                ...
                {businessFilter && <div className="timelineEventContainer">
                    ...
                    <div className="timelineEvent leftEvent">
                        ...
                        <div className="eventInformation">
                            ...
                            <p className="tools">
                                <img src={tools} alt="Tools" className="toolsIcon icons" />
                ...
                {educationFilter && <div className="timelineEventContainer">
                    ...
                    <div className="timelineEvent rightEvent">
                        ...
                        <div className="eventInformation">
                            ...
                            <p className="tools">
                                <img src={education} alt="Education" className="educationIcon icons" />
                ...
                {familyFilter && <div className="timelineEventContainer">
                    ...
                    <div className="timelineEvent leftEvent">
                        ...
                        <div className="eventInformation">
                            ...
                            <p className="tools">
                                <img src={bottle} alt="Bottle" className="bottleIcon icons" />
                                Natalie
                            </p>
                            <p className="description">Started working at World Acceptance Corporation in Customer Care. I noticed the data was all over the place and started working with Excel to fix it. I then found the developer side of Excel and started using VBA to create more robust solutions.</p>
                        </div>
                ...
                {familyFilter && <div className="timelineEventContainer">
                    ...
                    <div className="timelineEvent leftEvent">
                        ...
                        <div className="eventInformation">
                            ...
                            <p className="tools">
                                <img src={ring} alt="Ring" className="ringIcon icons" />
                                Courtney
                            </p>
                            <p className="description">Started working at World Acceptance Corporation in Customer Care. I noticed the data was all over the place and started working with Excel to fix it. I then found the developer side of Excel and started using VBA to create more robust solutions.</p>
                        </div>
                ...
                {familyFilter && <div className="timelineEventContainer">
                    ...
                    <div className="timelineEvent leftEvent">
                        ...
                        <div className="eventInformation">
                            ...
                            <p className="tools">
                                <img src={house} alt="House" className="houseIcon icons" />
                                First Home!
                            </p>
                            <p className="description">Started working at World Acceptance Corporation in Customer Care. I noticed the data was all over the place and started working with Excel to fix it. I then found the developer side of Excel and started using VBA to create more robust solutions.</p>
                        </div>
                ...
                {familyFilter && <div className="timelineEventContainer">
                    ...
                    <div className="timelineEvent rightEvent">
                        ...
                        <div className="eventInformation">
                            ...
                            <p className="tools">
                                <img src={couple} alt="Couple" className="coupleIcon icons" />
                                Excel, VBA
                            </p>
                            <p className="description">Started working at World Acceptance Corporation in Customer Care. I noticed the data was all over the place and started working with Excel to fix it. I then found the developer side of Excel and started using VBA to create more robust solutions.</p>
                        </div>
