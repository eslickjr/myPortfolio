...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    if (portfolioView.current === null) {
      portfolioView.current = new PortfolioView(projects);
            ...
            <div id="projectList">
              <div id="swipeContainer" className={dragging}>
                <span id="scrollText" className={dragging}>Click and drag to scroll
                  <svg id="swipeIcon" className={dragging} xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
              ...
              {projects.map((project, i) => {
                ...
                return (
                <Project projectKey={i} {...project} scrollRef={isScrolling} focus={(styleProps.current[i]?.opacity ?? '')} dragging={dragging} />
              )})}
            </div>
          </div>
        </div>
