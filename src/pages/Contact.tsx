...
export default function Contact() {
  ...
  return (
    <section id="contact">
      <div id="generalInfoWrapper" className={loaded ? "fadeIn" : ""}>
        <div id="generalInfoContainer">
          ...
          <div id='generalBox'>
            ...
            <div id="generalLinks">
              <a className="generalButton" id="hireResume" href="/Joshua-Eslick-Resume.pdf" download>
