    ...
    return (
        <div className="about">
            ...
            <div id="earlyLifeContainer" className="stageContainer leftLife">
                <p id="earlyLife" className={`lifeParagraph ${inView[0] ? "inView" : "outView"}`}>
            ...
            <div id="buddingDeveloperContainer" className="stageContainer rightLife">
                ...
                <p id="buddingDeveloper" className={`lifeParagraph ${inView[1] ? "inView" : "outView"}`}>
            ...
            <div id="youngAdultContainer" className="stageContainer leftLife">
                <p id="youngAdult" className={`lifeParagraph ${inView[2] ? "inView" : "outView"}`}>
            ...
            <div id="climbingTheLadderContainer" className="stageContainer rightLife">
                ...
                <p id="climbingTheLadder" className={`lifeParagraph ${inView[3] ? "inView" : "outView"}`}>
            ...
            <div id="currentEmploymentContainer" className="stageContainer leftLife">
                <p id="currentEmployment" className={`lifeParagraph ${inView[4] ? "inView" : "outView"}`}>
            ...
            <div id="futureContainer" className="stageContainer rightLife">
                ...
                <p id="future" className={`lifeParagraph ${inView[5] ? "inView" : "outView"}`}>
